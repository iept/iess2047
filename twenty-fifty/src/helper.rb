...
module Helper
  ...
  def classic_table_row_for_choice(choice)
    ...
    row << "<td width='20px'><a href='/assets/onepage/#{choice.doc}' target='_new' onmouseover='twentyfifty.startDemo(#{choice.number}); return true;' onmouseout='twentyfifty.stopDemo(#{choice.number});return true;'><img width='20px' src='/assets/images/question.png'></a></td>"
